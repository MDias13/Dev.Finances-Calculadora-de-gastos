...
let Modal = {
    open(){
        ...
        document.querySelector('.modal-overley').classList.add('active');
    },
    close(){
        //fechar Modal
        //remover classe active do modal
        document.querySelector('.modal-overley').classList.remove('active');
    }
}
const Storage = {
    get(){
    ...
    set(transactios){
        localStorage.setItem("dev.finances:transactions",JSON.stringify(transactios))
    }
}
const Transaction = {
    all: Storage.get(),
